...
CREATE TABLE `ad_creative`  (
  ...
  `duration` int(10) NOT NULL DEFAULT 0 COMMENT '持续时长, 只有视频才不为0',
...
CREATE TABLE `ad_unit_district`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '推广单元地域Feature' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ad_unit_it`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '推广单元兴趣Feature' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ad_unit_keyword`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '推广单元关键词Feature' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ad_user`  (
  ...
  `token` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '给用户生成的token',
